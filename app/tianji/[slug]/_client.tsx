    ...
    <div style={{ background: c.bgBase, transition: 'background 0.35s ease' }} className="overflow-x-hidden">
          ...
          <div className="mx-auto" style={{ maxWidth: '960px' }}>
            <TianjiFadeIn>
              <div className="rounded-2xl p-6 lg:p-10 space-y-5"
                ...
                <SectionEyebrow align="left" className="mb-2">详细介绍</SectionEyebrow>
      ...
      {sortedChapters.length > 0 && (
        <section className="relative px-6 py-12">
          <div className="mx-auto" style={{ maxWidth: '960px' }}>
            <TianjiFadeIn>
              <SectionEyebrow className="mb-6">课程章节</SectionEyebrow>
            </TianjiFadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <TianjiFadeIn delay={0.1}>
              <div className="rounded-2xl p-6 h-full"
                ...
                <SectionEyebrow align="left" className="mb-4">参考书目</SectionEyebrow>
