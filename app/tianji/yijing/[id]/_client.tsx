          ...
          <div className="space-y-4">
            ...
            <TianjiFadeIn delay={0.1}>
              <motion.div
                ...
                <div className="flex items-center justify-between flex-wrap gap-2 mb-4">
                  <SectionEyebrow align="left">卦辞 · Meaning</SectionEyebrow>
                  {classicSrc && (
                    <span
            ...
            {classicSrc && (
              <TianjiFadeIn delay={0.15}>
                ...
                >
                  <SectionEyebrow align="left" className="mb-5">古籍原文 · 倪师解读 对照</SectionEyebrow>
            ...
            <TianjiFadeIn delay={0.2}>
              <motion.div
                ...
                <SectionEyebrow align="left" className="mb-4">倪师解读 · Ni Interpretation</SectionEyebrow>
            ...
            <TianjiFadeIn delay={0.3}>
              <motion.div
                ...
                <SectionEyebrow align="left" className="mb-4">断事要诀 · Divination</SectionEyebrow>
